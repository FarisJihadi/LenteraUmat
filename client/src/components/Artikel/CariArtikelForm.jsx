...
export default function CariArtikelForm({
  ...
  const fetchArticles = async () => {
    try {
      ...
      setLoading(false); // Pastikan loading dihentikan jika error
    }
  };

  // Jalankan fetchArticles saat komponen pertama kali dimuat
  useEffect(() => {
    fetchArticles();
  }, []); // eslint-disable-line react-hooks/exhaustive-deps

  // Jalankan fetchArticles setiap kali `selectedSort` berubah (setelah render pertama)
  useEffect(() => {
    if (isInitialMount.current) {
      isInitialMount.current = false;
      return; // Lewati eksekusi pada render pertama
    }
    fetchArticles();
