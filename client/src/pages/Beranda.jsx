...
import heroBeranda from "../assets/Beranda/heroBeranda.png";
import childImg from "../assets/Beranda/child.png";
import donateIcon from "../assets/Beranda/donate.png";
import peopleIcon from "../assets/Beranda/people.png";
import komunitas1 from "../assets/Beranda/komunitas1.png";
import komunitas2 from "../assets/Beranda/komunitas2.png";
import komunitas3 from "../assets/Beranda/komunitas3.png";
import komunitas4 from "../assets/Beranda/komunitas4.png";
import komunitas5 from "../assets/Beranda/komunitas5.png";
import visi_misi from "../assets/Beranda/visi_misi.png";
  ...
  return (
    <>
      <section className="relative md:h-screen sm:h-screen h-[60vh] w-full">
        {/* Background Image */}
        <img src={heroBeranda} alt="Children learning" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex flex-col gap-4 justify-center h-full px-10 md:px-16 lg:px-36 text-white">
          ...
          <p className="mt-4 text-base sm:text-lg md:text-md max-w-sm">Satu donasi anda bisa membuka akses belajar bagi anak bangsa.</p>
          <button onClick={() => navigate(targetPath)} className="mt-6 w-fit inline-flex gap-2 items-center bg-primary hover:bg-primary-700 text-white font-medium px-5 py-3 rounded-full transition duration-300">
            <p>{buttonText}</p>
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-6 px-6 py-16 md:px-40 md:py-32 text-center md:text-left">
      <div className="w-full md:max-w-md">
        <h2 className="md:text-[44px] text-3xl font-bold mb-4 md:mb-8">
          Apa itu <span className="text-primary">Setarain</span>?
        </h2>
        <p className="text-gray-700 text-lg">
          Setarain adalah platform donasi barang pendidikan untuk mewujudkan pendidikan yang inklusif. Platform ini menghubungkan donatur dari semua kalangan dengan komunitas pendistribusi yang kemudian disalurkan ke anak-anak yang memiliki
          fasilitas pendidikan kurang layak.
        </p>
      </div>
      <div className="w-full md:w-1/3">
        <img src={childImg} alt="Anak menggunakan kursi roda" className="rounded-lg shadow-md w-full max-w-xs mx-auto md:max-w-full md:mx-0" />
      </div>
    </section>
  );
}
...
function MisiSec() {
  return (
    <section className="px-6 md:px-20 py-16">
      <div className="bg-gradient-to-br from-[#98D2C0] to-[#4F959D] text-white py-16 px-6 md:px-24 rounded-xl shadow-md">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/3">
            <h3 className="text-4xl font-bold text-center mb-6">Misi Kami</h3>
            <img src={visi_misi} alt="Anak menggunakan kursi roda" className="rounded-lg shadow-md w-full max-w-xs mx-auto md:max-w-full md:mx-0" />
          </div>
          <div className="w-full md:w-2/3 md:pl-16">
            <div className="space-y-6">
              <div>
                <p className="font-bold text-2xl">01</p>
                <p>Memastikan penyandang disabilitas dan masyarakat di daerah 3T memperoleh fasilitas pendidikan yang sesuai melalui sistem distribusi berbasis prioritas kebutuhan.</p>
              </div>
              <div>
                <p className="font-bold text-2xl">02</p>
                <p>Membangun mekanisme penyaluran alat pendidikan yang terukur, akuntabel, dan berkelanjutan, dari donatur hingga ke tangan penerima.</p>
              </div>
              <div>
                <p className="font-bold text-2xl">03</p>
                <p>Mendorong partisipasi masyarakat luas—individu, korporasi, hingga lembaga pendidikan—dalam membentuk ekosistem donasi inklusif untuk pemerataan kesempatan belajar.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 mb-24 sm:px-6">
      <div className="flex flex-col sm:flex-row sm:justify-between px-8 sm:items-center mb-6 gap-2 sm:gap-0">
        ...
        <Link to={"artikel"} className="text-blue-600 md:text-sm text-xs text-left  hover:underline sm:text-right">
          Lihat semua
        </Link>
      </div>
      {loading && (
...
function TargetSec() {
  return (
    <section className="bg-[#205D88] text-white py-16 px-6 md:px-20">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-20">
        <div className="bg-white text-[#205D88] rounded-xl shadow-md p-10 md:p-16 text-center w-full md:w-1/3">
          ...
          <p className="mt-2">Donasi alat pendidikan yang mengubah akses belajar.</p>
        </div>
        <div className="bg-white text-[#205D88] rounded-xl shadow-md p-10 md:p-16 text-center w-full md:w-1/3">
          <p className="text-2xl font-bold">1500+ Komunitas</p>
          <p className="mt-2">Mitra komunitas yang percaya pada transparansi Setarain.</p>
        </div>
      </div>
    </section>
  );
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 my-16 md:my-32">
        ...
        <Link to="/daftar">
          <div className="bg-white rounded-xl shadow-[0_0_8px_0px_rgba(0,0,0,0.2)] px-8 py-16 text-center w-full md:w-80 border border-gray-200 flex flex-col items-center">
            <h3 className="text-2xl font-bold mb-4">Pilih Peranmu, Wujudkan Mimpi Mereka</h3>
            <p className="text-gray-600 mb-6">Berkontribusi sebagai donatur atau bergabung langsung sebagai agen perubahan.</p>
            <button className="flex gap-2 px-6 py-3 bg-primary text-white rounded-full hover:bg-primary-dark transition font-medium">
              <p>Daftar Sekarang</p>
              <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="24.4" height="24" rx="12" fill="#F6F8D5" />
                <path
...
const PartnerSec = () => {
  ...
  return (
    <section className="pmt-24 md:mt-0 md:mb-48 bg-white overflow-hidden">
      <h2 className="text-center text-3xl md:text-4xl font-semibold mb-14">Partner Kami</h2>
      <div className="w-full px-6 md:px-14">
        <div className="flex flex-wrap gap-8 md:gap-12 justify-center md:justify-evenly">
          {[...logos].map((src, index) => (
            <div key={index} className="flex-shrink-0 rounded-full overflow-hidden">
              <img src={src} alt={`Partner logo ${index + 1}`} className="w-20 h-20 md:w-32 md:h-32 object-cover opacity-80 hover:opacity-100 transition" />
            </div>
          ))}
        </div>
      </div>
