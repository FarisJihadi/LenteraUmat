...
function UmmahBook() {
  ...
  const mockBooks = [
    ...
    },
    {
      ...
      title: "Pendidikan Agama Islam dan Budi Pekerti",
      grade: "Kelas VII",
      imageUrl: "https://via.placeholder.com/200x280/4DB6AC/FFFFFF?text=Buku+PAI",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Pendidikan Agama Islam dan Budi Pekerti",
      grade: "Kelas VIII",
      imageUrl: "https://via.placeholder.com/200x280/26A69A/FFFFFF?text=Buku+PAI",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      grade: "Kelas X",
      imageUrl: "https://via.placeholder.com/200x280/00897B/FFFFFF?text=Buku+SKI",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Lengkap",
      imageUrl: "https://via.placeholder.com/200x280/00695C/FFFFFF?text=Buku+Umum",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      title: "Matematika",
      grade: "Kelas IV",
      imageUrl: "https://via.placeholder.com/200x280/FF7043/FFFFFF?text=Buku+MTK",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      grade: "Kelas V",
      imageUrl: "https://via.placeholder.com/200x280/FF5722/FFFFFF?text=Buku+Indo",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      grade: "Kelas VI",
      imageUrl: "https://via.placeholder.com/200x280/76FF03/000000?text=Buku+IPA",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      grade: "Kelas IX",
      imageUrl: "https://via.placeholder.com/200x280/FFC107/000000?text=Buku+IPS",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      grade: "Kelas VII",
      imageUrl: "https://via.placeholder.com/200x280/29B6F6/FFFFFF?text=Buku+Eng",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Fisika",
      grade: "Kelas XI",
      imageUrl: "https://via.placeholder.com/200x280/42A5F5/FFFFFF?text=Buku+Fisika",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      title: "Kimia",
      grade: "Kelas XII",
      imageUrl: "https://via.placeholder.com/200x280/1E88E5/FFFFFF?text=Buku+Kimia",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      title: "Biologi",
      grade: "Kelas X",
      imageUrl: "https://via.placeholder.com/200x280/66BB6A/FFFFFF?text=Buku+Bio",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
    ...
    },
    {
      ...
      title: "Akidah Akhlak",
      grade: "Kelas III",
      imageUrl: "https://via.placeholder.com/200x280/A1887F/FFFFFF?text=Buku+Akidah",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      title: "Fiqih",
      grade: "Kelas VIII",
      imageUrl: "https://via.placeholder.com/200x280/8D6E63/FFFFFF?text=Buku+Fiqih",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Ekonomi",
      grade: "Kelas XI",
      imageUrl: "https://via.placeholder.com/200x280/9CCC65/000000?text=Buku+Ekonomi",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Lengkap",
      imageUrl: "https://via.placeholder.com/200x280/5C6BC0/FFFFFF?text=Buku+Doa",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      grade: "Kelas I",
      imageUrl: "https://via.placeholder.com/200x280/FFEE58/000000?text=Tematik",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      title: "Sosiologi",
      grade: "Kelas XII",
      imageUrl: "https://via.placeholder.com/200x280/AB47BC/FFFFFF?text=Buku+Sosiologi",
      fileType: "PDF",
      category: "SMA/MA",
    },
    ...
    // New entries 21–50
    {
      ...
      title: "Geografi",
      grade: "Kelas X",
      imageUrl: "https://via.placeholder.com/200x280/7E57C2/FFFFFF?text=Buku+Geo",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Kelas XI",
      imageUrl: "https://via.placeholder.com/200x280/5E35B1/FFFFFF?text=Buku+PKN",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Kelas XII",
      imageUrl: "https://via.placeholder.com/200x280/3949AB/FFFFFF?text=Buku+TIK",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      title: "Prakarya",
      grade: "Kelas VII",
      imageUrl: "https://via.placeholder.com/200x280/1E88E5/FFFFFF?text=Buku+Prakarya",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Seni Budaya",
      grade: "Kelas VIII",
      imageUrl: "https://via.placeholder.com/200x280/00ACC1/FFFFFF?text=Buku+Seni",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Bahasa Arab",
      grade: "Kelas IX",
      imageUrl: "https://via.placeholder.com/200x280/00838F/FFFFFF?text=Buku+Arab",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Matematika",
      grade: "Kelas VII",
      imageUrl: "https://via.placeholder.com/200x280/D84315/FFFFFF?text=Buku+MTK",
      fileType: "PDF",
      category: "SMP/MTS",
    },
    {
      ...
      title: "Bahasa Inggris",
      grade: "Kelas XI",
      imageUrl: "https://via.placeholder.com/200x280/039BE5/FFFFFF?text=Buku+Eng",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      title: "Biologi",
      grade: "Kelas XII",
      imageUrl: "https://via.placeholder.com/200x280/43A047/FFFFFF?text=Buku+Bio",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Kelas VI",
      imageUrl: "https://via.placeholder.com/200x280/FFCA28/000000?text=Buku+PJOK",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      title: "Tematik Terpadu",
      grade: "Kelas II",
      imageUrl: "https://via.placeholder.com/200x280/FDD835/000000?text=Tematik",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      title: "Bahasa Daerah",
      grade: "Kelas IV",
      imageUrl: "https://via.placeholder.com/200x280/EF6C00/FFFFFF?text=Bhs+Daerah",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
      ...
      grade: "SMK",
      imageUrl: "https://via.placeholder.com/200x280/6D4C41/FFFFFF?text=SMK+Oto",
      fileType: "PDF",
      category: "SMK",
    },
    {
    ...
    },
    {
      ...
      grade: "SMK",
      imageUrl: "https://via.placeholder.com/200x280/607D8B/FFFFFF?text=Akuntansi",
      fileType: "PDF",
      category: "SMK",
    },
    {
      ...
      grade: "Lengkap",
      imageUrl: "https://via.placeholder.com/200x280/C2185B/FFFFFF?text=Mandarin",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      grade: "Lengkap",
      imageUrl: "https://via.placeholder.com/200x280/D81B60/FFFFFF?text=Parenting",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      grade: "Kelas XI",
      imageUrl: "https://via.placeholder.com/200x280/AD1457/FFFFFF?text=Sejarah+Indo",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      grade: "Kelas V",
      imageUrl: "https://via.placeholder.com/200x280/6A1B9A/FFFFFF?text=Life+Skills",
      fileType: "PDF",
      category: "SD/MI",
    },
    {
    ...
    },
    {
      ...
      grade: "Kelas X",
      imageUrl: "https://via.placeholder.com/200x280/880E4F/FFFFFF?text=Logika+MTK",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
      ...
      title: "Agribisnis",
      grade: "SMK",
      imageUrl: "https://via.placeholder.com/200x280/33691E/FFFFFF?text=Agribisnis",
      fileType: "PDF",
      category: "SMK",
    },
    {
    ...
    },
    {
      ...
      imageUrl: "https://via.placeholder.com/200x280/0277BD/FFFFFF?text=Kalkulus",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      grade: "Lengkap",
      imageUrl: "https://via.placeholder.com/200x280/00695C/FFFFFF?text=Psikologi",
      fileType: "PDF",
      category: "Umum",
    },
    {
      ...
      grade: "SMA",
      imageUrl: "https://via.placeholder.com/200x280/004D40/FFFFFF?text=Lingkungan",
      fileType: "PDF",
      category: "SMA/MA",
    },
    {
    ...
    },
    {
      ...
      grade: "SMK",
      imageUrl: "https://via.placeholder.com/200x280/BF360C/FFFFFF?text=Wirausaha",
      fileType: "PDF",
      category: "SMK",
    },
    {
      ...
      <main className="bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
            ...
            <select value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="w-full md:w-auto px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500">
              <option>Semua</option>
              <option>SD/MI</option>
